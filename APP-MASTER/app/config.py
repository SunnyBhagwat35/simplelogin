...
EMAIL_DOMAIN ="mydomain.com"  # os.environ["EMAIL_DOMAIN"].lower()
SUPPORT_EMAIL = "support@mydomain.com" # os.environ["SUPPORT_EMAIL"]
...
EMAIL_SERVERS_WITH_PRIORITY =[(10, "app.privasedoc.com.")]   # sl_getenv("EMAIL_SERVERS_WITH_PRIORITY")

# disable the alias suffix, i.e. the ".random_word" part
DISABLE_ALIAS_SUFFIX =1  # "DISABLE_ALIAS_SUFFIX" in os.environ
...
if "DKIM_PRIVATE_KEY_PATH" in os.environ:
    DKIM_PRIVATE_KEY_PATH ="/dkim.key"  # get_abs_path(os.environ["DKIM_PRIVATE_KEY_PATH"])
...
if os.environ.get("GNUPGHOME"):
    GNUPGHOME = "sl/pgp"  # get_abs_path(os.environ.get("GNUPGHOME"))
else:
...
LOCAL_FILE_UPLOAD =1  # "LOCAL_FILE_UPLOAD" in os.environ
UPLOAD_DIR = None
